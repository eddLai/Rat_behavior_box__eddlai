...
def printCircles(frame, circle_list): # circle_list = circle_pos_list
    # cv2.circle(img, center position, radius, color)
    cv2.circle(frame, (circle_list[0][1], circle_list[0][2]), 25, (0, 0, 255), -1) #red  (M)
    cv2.circle(frame, (circle_list[1][1], circle_list[1][2]), 15, (255, 0, 0), -1) #blue (L)
    cv2.circle(frame, (circle_list[2][1], circle_list[2][2]), 15, (0, 255, 0), -1) #green(R)
...
try:
    ...
    target_M_x = 50 # red qiu qiu
    target_M_y = 50
    target_L_x = 100 # blue qiu qiu
    target_L_y = 100
    target_R_x = 150 # green qiu qiu
    target_R_y = 150
    target_MD_x = 200 # black qiu qiu 1
    target_MD_y = 200
    target_LD_x = 250 # black qiu qiu 2
    target_LD_y = 250
